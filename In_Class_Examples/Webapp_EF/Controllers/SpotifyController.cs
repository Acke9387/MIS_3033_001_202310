...
namespace Webapp_EF.Controllers
{
    public class SpotifyController : Controller
    {
        ...
        public async Task<IActionResult> Index(string id = "", string genre = "")
        {
            ...
            if (genre != "")
            {
                songs = _context.Spotify.Where(song => song.TopGenre == genre).ToList();
            }
            else
            {
                songs = _context.Spotify.ToList();
            }
        ...
        public async Task<IActionResult> Genres()
        {
            ...
            //foreach (var song in _context.Spotify)
            //{
            ...
            genres = _context.Spotify.Select(s => s.TopGenre).Distinct().ToList();
